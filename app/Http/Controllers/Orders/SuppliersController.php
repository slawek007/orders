...
class SuppliersController extends Controller
{
    ...
    public function store(validateSupplierAndCustomer $request)
    {
        ...
        return redirect(action('Orders\SuppliersController@show', Suppliers::get()->last()->id))->with('success', 'Dostawca został dodany do bazy !.');
    }
    ...
    public function update(Suppliers $supplier)
    {
        ...
        return redirect(action('Orders\SuppliersController@show', $supplier->id));
    }
    ...
    {
        $supplier->delete();
        return redirect(action('Orders\SuppliersController@index'))->with('success', 'Usunięto rekord z bazy !.');
    }
}
