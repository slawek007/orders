...
<head>
    ...
    <title>{{ config('app.name', 'PAREO-POLSKA') }}</title>

    <!-- Scripts -->
    <script src="{{ asset('js/app.js') }}"></script>
    <script src="{{ asset('js/displayEvents.js') }}"></script>
...
<body>
    ...
    @stack('endSiteScripts')
    @yield('endSiteFunctions')
</body>
</html>
